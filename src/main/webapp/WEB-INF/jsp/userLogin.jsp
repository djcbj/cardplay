...
<body>
    <div class="login-logo"><h1>登录账号</h1></div>
    <div class="login-box">
        <form class="layui-form layui-form-pane" action="${pageContext.request.contextPath}/adm/login" method="post">
            <h3>登录你的帐号</h3>
            ...
            <div class="form-actions">
                ...
                <div class="forgot"><a href="${pageContext.request.contextPath}/adm/registerPage" class="forgot">注册</a></div>
            </div>
        </form>
    </div>
    <script>
